...
def test_langgraph_sdk_mutation_keeps_existing_csrf_exemption_without_token():
    client = TestClient(_make_app(), base_url="https://deerflow.example")
...
def test_langgraph_sdk_mutation_keeps_existing_csrf_exemption_with_mismatched_token():
    client = TestClient(_make_app(), base_url="https://deerflow.example")
