...
def get_available_tools(
    ...
    # built-ins, MCP tools, ACP tools, and plugin tools.  Duplicate names cause
    # the LLM to receive ambiguous or concatenated function schemas (issue #1803).
    all_tools = [_ensure_sync_invocable_tool(t) for t in loaded_tools + builtin_tools + mcp_tools + acp_tools + plugin_tools]
