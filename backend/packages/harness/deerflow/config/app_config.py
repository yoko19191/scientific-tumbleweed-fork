...
class AppConfig(BaseModel):
    ...
    def _apply_singleton_configs(cls, config: Self, acp_agents: dict[str, ACPAgentConfig]) -> None:
        ...
        load_permissions_config_from_dict(config.model_extra.get("permissions") if config.model_extra else None)
        load_hooks_config_from_dict(config.model_extra.get("hooks") if config.model_extra else None)
        load_plugins_config_from_dict(config.model_extra.get("plugins") if config.model_extra else None)
        ...
        load_storage_config_from_dict(config.storage.model_dump())
...
def get_app_config() -> AppConfig:
    """Get the Scientific Tumbleweed config instance.
