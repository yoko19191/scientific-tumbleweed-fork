...
export type TokenUsagePreset = "off" | "per_run" | "per_turn" | "step_debug";

export const TOKEN_USAGE_PRESETS: TokenUsagePreset[] = [
  "per_turn",
  "per_run",
  "step_debug",
  "off",
...
export function isTokenUsagePreset(value: unknown): value is TokenUsagePreset {
  return (
    value === "off" ||
    value === "per_run" ||
    value === "per_turn" ||
...
function getTokenUsageAttribution(
  ...
  return normalizeTokenUsageAttribution(attribution);
}
