...
class TestAgentConstruction:
    ...
    async def test_build_initial_state_consolidates_system_prompt_and_skills(
        ...
        async def load_skills():
            return [SimpleNamespace(name="my-skill", skill_file=skill_file, allowed_tools=None)]
...
class TestAsyncExecutionPath:
    ...
    async def test_aexecute_passes_at_most_one_system_message_to_agent(
        ...
        async def load_skills():
            return [SimpleNamespace(name="regression-skill", skill_file=skill_dir / "SKILL.md", allowed_tools=None)]
