#!/usr/bin/env bash
#
# start-daemon.sh - Start all Scientific Tumbleweed development services in daemon mode
#
# This script starts Scientific Tumbleweed services in the background without keeping
...
echo ""
echo "=========================================="
echo " Starting Scientific Tumbleweed in Daemon Mode"
echo "=========================================="
echo ""
...
echo ""
echo "=========================================="
echo " Scientific Tumbleweed is running in daemon mode!"
echo "=========================================="
echo ""
