...
async def get_channels_status(_user_id: str = Depends(get_current_user_id)) -> ChannelStatusResponse:
...
async def restart_channel(name: str, _user_id: str = Depends(get_current_user_id)) -> ChannelRestartResponse:
