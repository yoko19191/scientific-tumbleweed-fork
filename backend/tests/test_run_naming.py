...
def test_resolve_root_run_name_from_context_agent_name():
    assert resolve_root_run_name({"context": {"agent_name": "finalis"}}, "chat_lead_agent") == "finalis"


def test_resolve_root_run_name_from_configurable_agent_name():
    assert resolve_root_run_name({"configurable": {"agent_name": "finalis"}}, "chat_lead_agent") == "finalis"
...
def test_resolve_root_run_name_falls_back_to_chat_lead_agent():
    assert resolve_root_run_name({}, None) == "chat_lead_agent"
...
def test_resolve_root_run_name_prefers_context_over_configurable():
    ...
    assert resolve_root_run_name(config, "chat_lead_agent") == "ctx-agent"
